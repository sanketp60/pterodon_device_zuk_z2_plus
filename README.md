...
For building PterodonRecovery for Lenovo ZUK Z2 / Z2 Plus ONLY

To compile

`export ALLOW_MISSING_DEPENDENCIES=true; . build/envsetup.sh; lunch omni_z2_plus-eng; mka recoveryimage`
